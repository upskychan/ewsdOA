...
<header id="bjui-header">
    ...
    <nav id="bjui-navbar-collapse">
        <ul class="bjui-navbar-right">
        	<li><a href="#"><span class="badge">${sessionScope.USER.account}</span>，欢迎您！</a></li>
...
<!--                     <li><a href="{:U('Admin/Public/loginOut')}" class="red">&nbsp;<span class="fa fa-power-off"></span> 注销登陆</a></li> -->
					<li><a href="<%=request.getContextPath()%>/login/logout.do" class="red">&nbsp;<span class="fa fa-power-off"></span> 注销登录</a></li>
                </ul>
            </li>
